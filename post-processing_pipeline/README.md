...
* grab\_dates.bat grabs the datetime exif data from all input images for later analysis
* grab\_pixels.py grabs the pixel area of each insect within a crop for later analysis. This value has been found to correlate well with insect biomass in the literature (R^2 ~= 0.7).

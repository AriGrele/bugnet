...
Running on GPU requires a Pytorch installation with GPU support ([https://pytorch.org/get-started/locally/](https://pytorch.org/get-started/locally/)) and the corresponding version of the CUDA Toolkit ([https://developer.nvidia.com/cuda-downloads](https://developer.nvidia.com/cuda-downloads)). Note that the version of CUDA you install will depend on what software your GPU can support; misalignments between GPU model, CUDA version, and Pytorch version will result in errors.
